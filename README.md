...
4. Bouw stap voor stap de code behind van de **WPF** op. Voeg naar gelang je die nodig hebt **bijkomende methoden toe in de entities en/of services**. Alle logica die niet specifiek voor de GUI geschreven wordt, hoort thuis in de class library! Werk bv. in deze volgorde:
   ...
   3. Zorg ervoor dat het venster **WinResidences** getoond wordt wanneer je op "View" klikt en dat de informatie die hoort bij het geselecteerde verblijf getoond wordt in dit scherm (niet editeerbaar).
   4. Analoog voor de knop "Edit", maar nu zijn de gegevens in het venster **WinResidences** wel editeerbaar. Je kan je wijziging bewaren of annuleren.
   5. Opnieuw analoog: zorg ervoor dat het venster **WinResidences** ook getoond wordt als je op de knop "New" klikt. Deze keer zijn alle velden leeg. Opnieuw kan je het nieuwe verblijf bewaren of de actie annuleren.
